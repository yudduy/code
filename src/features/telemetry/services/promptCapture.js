...
async function startCapture(screenshotIntervalSeconds = 5, imageQuality = 'medium') {
    ...
    try {
        ...
        // Note: codexel.e() is not available in this context, commenting out
        // codexel.e().setStatus('error');
    }
}
...
if (typeof window !== 'undefined') {
    ...
    window.codexel = window.codexel || {};
    window.codexel.startCapture = startCapture;
    window.codexel.stopCapture = stopCapture;
    window.codexel.captureManualScreenshot = captureManualScreenshot;
    window.codexel.getCurrentScreenshot = getCurrentScreenshot;
    window.codexel.getTelemetryEvents = getTelemetryEvents;
    window.codexel.setSessionId = setSessionId;
} 